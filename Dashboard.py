...
st.title("📊 Dashboard Financiero - Fondo de Inversión Giancarlo Fallone")

# ================================
# 📁 Subida de archivo
# ================================
uploaded_file = st.file_uploader("Sube el archivo Excel del fondo de inversión (.xlsx)", type=["xlsx"])
...
if uploaded_file:
    try:
        ...
        # ================================
        with st.sidebar.expander("📅 Filtros por Fecha", expanded=True):
            fecha_min = df["Fecha"].min()
            fecha_max = df["Fecha"].max()
            fecha_inicio, fecha_fin = st.date_input("Selecciona el rango de fechas", 
                                                     [fecha_min, fecha_max],
                                                     min_value=fecha_min, 
                                                     max_value=fecha_max)
