...
if uploaded_file:
    try:
        ...
        if pagina == "📌 KPIs":
            ...
            styled_kpi("📆 Promedio Mensual de Ganancias", f"${promedio_mensual_ganancias:,.2f}", "#E0F7FA", tooltip="Promedio de las ganancias brutas mensuales durante el período seleccionado.")
